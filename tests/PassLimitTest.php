...
use IComeFromTheNet\PointsMachine\Compiler\Pass\LimitPass;
use IComeFromTheNet\PointsMachine\Compiler\CompileResult;


class PassLimitTest extends CompilerTest
{
   
    protected $aFixtures = ['example-system.php','pass-limit-before.php'];
    ...
    public function testPassSuccessful()
    {
        ...
        $oPass = new LimitPass($oContainer->getDatabaseAdaper(),$oContainer->getGatewayCollection());
        
        
        $oPass->execute(new DateTime('now'), $oResult);
        
        $oExpectedDataset = $this->getDataSet(['example-system.php','pass-limit-after.php'])->getTable('pt_result_rank');
